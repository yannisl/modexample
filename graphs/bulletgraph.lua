...
--- main parameters are here
--m:define_colors('color', 5)
--m:definecolor('barcolour','orange!90')

-- m.definecolor('ylgnbu1','blue!10')
-- m.definecolor('ylgnbu2','blue!25')
-- m.definecolor('ylgnbu3','blue!40')
